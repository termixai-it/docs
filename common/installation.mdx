...
<Info>
**Streaming Mode Requirements**: If you enable `enableStreamingMode={true}`, your proxy endpoint must support Server-Sent Events (SSE). See the [Streaming Mode guide](/common/streaming) for detailed implementation instructions.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Streaming Mode" icon="bolt" href="/common/streaming">
