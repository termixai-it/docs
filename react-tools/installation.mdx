...
The SDK automatically connects to the Termix API:
- **Production**: `https://dashboard.termix.ai`  
- **Local Development**: `http://127.0.0.1:3001` (when using `npm run dev:local`)

<Warning>
Never expose your API keys directly in the frontend. The SDK expects you to provide appropriate authorization headers.
</Warning>
