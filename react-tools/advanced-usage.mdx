...
Unlock the full potential of @termix-it/react-tool with advanced features like function calling, smart contract integration, streaming mode, floating chat widgets, and custom implementations.
...
function DynamicWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6">
      ...
      <ChatWidget
        title={`Hi ${user.name}!`}
        subtitle={currentPage === '/dashboard' ? 'Dashboard Help' : 'Support'}
        defaultOpen={isOpen}
      ...
      >
        <ChatInterface
          ...
          enableFunctionCalls={true}
          welcomeMessage={getContextualWelcome()}
      ...
      <div className="fixed bottom-6 right-6">
        ...
        >
          <ChatInterface
            ...
            enableStreamingMode={true}
            welcomeMessage="Hi! I'm your support assistant. How can I help?"
          />
        </ChatWidget>
      </div>
      ...
      <div className="fixed bottom-6 left-6">
        ...
        >
          <ChatInterface
            ...
            enableStreamingMode={true}
            welcomeMessage="Interested in our products? I can help with pricing and features!"
          />
        </ChatWidget>
      </div>
      ...
      <div className="fixed top-6 right-6">
        ...
        >
          <ChatInterface
            ...
            enableStreamingMode={true}
            enableFunctionCalls={true}
            welcomeMessage="Need technical help? I can assist with APIs, integrations, and troubleshooting."
          />
        </ChatWidget>
      </div>
    </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <ChatInterface
        ...
        onError={handleError}
        welcomeMessage="Streaming mode active! Watch the real-time stats above."
      />
    </div>
  );
}
